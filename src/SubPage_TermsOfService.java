...
public class SubPage_TermsOfService extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_next1.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jTextArea1.setText("By using this application, you declare that you fully understand and accept these Terms of Service, subject to the following:\n\na. Terms of Use: You agree to use this application legally and ethically. Any illegal or unethical activities are strictly prohibited.\n\nb. Data Security: You are responsible for ensuring the security of your personal information and fixed asset records. Keep your passwords secure.\n\nc. Service Changes: The owner of the application reserves the right to change or remove features from the application at any time without prior notice."); // NOI18N
        ...
        tabbed_pane.addTab("1. Acceptance of Terms", pnl_1);

        btn_next2.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jTextArea2.setText("In conjunction with these Terms of Service, the application's Privacy Policy is also applicable. By reviewing the Privacy Policy, you will understand how your personal information is collected, used, and protected.\n");
        ...
        pnl_2Layout.setHorizontalGroup(
            ...
            .addGroup(pnl_2Layout.createSequentialGroup()
                ...
                .addGroup(pnl_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_next2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tabbed_pane.addTab("2. Privacy Policy", pnl_2);

        btn_next3.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jTextArea3.setText("All content of the application is protected by copyright and other intellectual property rights. Unauthorized copying or use is prohibited.");
        ...
        pnl_3Layout.setHorizontalGroup(
            ...
            .addGroup(pnl_3Layout.createSequentialGroup()
                ...
                .addGroup(pnl_3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_next3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tabbed_pane.addTab("3. Copyright and Trademark Rights", pnl_3);

        btn_next4.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jTextArea4.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        jTextArea4.setLineWrap(true);
        jTextArea4.setRows(5);
        jTextArea4.setText("The application owner is not responsible for any damage or loss arising from the use of the application. Users should use the application at their own risk.");
        ...
        pnl_4Layout.setHorizontalGroup(
            ...
            .addGroup(pnl_4Layout.createSequentialGroup()
                ...
                .addGroup(pnl_4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_next4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tabbed_pane.addTab("4. Disclaimer of Liability", pnl_4);

        btn_close.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jTextArea5.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        jTextArea5.setLineWrap(true);
        jTextArea5.setRows(5);
        jTextArea5.setText("The owner of the application reserves the right to change these Terms of Service at any time. Changes will be announced through the application, and the date of the changes will be specified.\n\nIn the event of a violation of these Terms of Service, the application owner reserves the right to suspend or terminate your account.\n\nPlease read these Terms of Service carefully and ensure that you agree to comply with these terms.");
        ...
        tabbed_pane.addTab("5. Changes to Terms of Service", pnl_5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubPage_TermsOfService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
